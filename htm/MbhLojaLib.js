...
if(PrecoProd!=PrecoOri)document.write("<br><font color=#666666>Economize</font><font color=red> <b>"+FormatPrice(PrecoOri-PrecoProd,'R$')+"</b> ("+FormatNum(((PrecoOri-PrecoProd)/PrecoOri)*100)+"%)</font>");
}
